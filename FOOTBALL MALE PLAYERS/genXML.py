...
#global variables
page_id = 400000#value should not conflict with any other pages

user_id='18100'  #we can get this info from downloaded xml
username='Vallepu saiteja'     #we can get this info from downloaded xml
